...
public class PatternVariableMap {
    ...
    public void putPatternVariable(String var, Object val) throws StringAnalysisException {
        if(patternVariableMap.containsKey(var)) { 
            throw new StringAnalysisException("Variable already exists in Pattern Variable Map.");
        } else {
